...
<main class="flex-1 flex items-center justify-center p-8 overflow-y-auto bg-white">
  <div class="w-full max-w-lg bg-white border border-gray-200 rounded-2xl shadow-lg p-8">
    <div class="mb-6 text-center">
      <h2 class="text-3xl font-bold text-gray-800">➕ Tambah Data</h2>
      <p class="text-gray-500 text-sm">Masukkan data mahasiswa baru ke dalam sistem</p>
    </div>
    ...
    <form action="{{ route('mahasiswa.store') }}" method="POST" class="space-y-5">
      ...
      <div>
        ...
        <input type="text" name="nama_mhs" placeholder="Masukkan Nama"
          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 transition" required>
      </div>

      <div class="mb-4">
      <label class="block text-sm font-semibold text-gray-700 mb-1">Kode Kelas</label>
      <select name="kode_kelas" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-400 transition">
      ...
      <select name="id_prodi" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-400 transition">
